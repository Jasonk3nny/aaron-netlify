...
Copyright: 2015-2021 Carolina Nymark
...
Version 4.4, 2021-07-24
Minor updates to improve the font family display in the block editor.
Fixed a problem where a stylesheet added to WordPress in 5.8 would overrride the themes editor style.
Improved support for new blocks added in 5.8 and blocks inside widget areas.
